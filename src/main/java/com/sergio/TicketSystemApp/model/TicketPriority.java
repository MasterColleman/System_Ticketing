...
public class TicketPriority {
    ...
    public void setTimeForPriority(
        ...
        if (count < 1) switch (priority) {
            ...
            case medium:
                if (timeForPriority <= 24) this.timeForPriority = timeForPriority;
            case high:
                if (timeForPriority <= 16) this.timeForPriority = timeForPriority;
            case urgent:
                if (timeForPriority <= 6) this.timeForPriority = timeForPriority;
        }
    }
