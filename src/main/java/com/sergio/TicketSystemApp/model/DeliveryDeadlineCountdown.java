...
public class DeliveryDeadlineCountdown extends JFrame {
    ...
    public DeliveryDeadlineCountdown() {
        panel = new JPanel();
        ...
        setTitle("Countdown Delivery Deadline");
